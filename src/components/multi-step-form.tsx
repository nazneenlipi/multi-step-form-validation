...
export default function MultiStepForm() {
  ...
  const { mutate, isPending, isSuccess, isError, error, reset: resetMutation } = useSubmitForm()
      ...
      if (isPending) {
        return (
          <div className="flex flex-col items-center justify-center py-8">
            ...
            <h3 className="text-xl font-medium">Submitting your information...</h3>
            <p className="text-muted-foreground mt-2">Please wait while we process your submission.</p>
          </div>
        )
      }
      ...
      if (isSuccess) {
        return (
          <div className="flex flex-col items-center justify-center py-8">
            ...
            <p className="text-muted-foreground mt-2">Thank you for completing the form.</p>
        ...
        return (
          <div className="py-6">
            ...
            <div className="flex justify-center">
              <Button onClick={() => mutate(methods.getValues())} className="mr-2">
                Try Again
              </Button>
